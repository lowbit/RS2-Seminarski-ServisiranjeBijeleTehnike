...
{
    public class ServisiDetailViewModel: BaseViewModel
    {
        private readonly APIService _servisiService = new APIService("Servisi"); 
        public ServisiDetailViewModel()
        {
        }
        public ServisiDetailViewModel(int id)
        {
        ...
        {
            await Application.Current.MainPage.Navigation.PushAsync(new UpdateStanjeServisaPage(Servis.ServisId));
        }
    }
}
